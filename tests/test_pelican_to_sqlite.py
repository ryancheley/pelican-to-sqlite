...
def test_basic(tmpdir):
    ...
    assert one["content"] == "The requested item could not be located. \n\n"
    ...
    assert two["content"] == "In a [previous post](/rules-and-actions-in-outlook.html) I spoke about my use of Rules and Custom Actions in Outlook. In this post I’ll talk about my Review process which I adapted from David Allen’s *Getting Things Done* methodology.\n\n"
